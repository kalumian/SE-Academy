...
class App extends Component{
  ...
  // Functions-----------------------------
    const Switchs = () =>{
      this.state.SwitchMode ? this.setState({SwitchMode:false}) : this.setState({SwitchMode:true})
   }
  return (
    <>
    <Router>
            <Switch>
             ...
             <Route path="/courses/:nameField/:nameCourses/:nameCourse/:episode" component={ShowVideos}/>
             <Route path="/courses/:nameField/:nameCourses/:nameCourse" component={ListVideos}/>
