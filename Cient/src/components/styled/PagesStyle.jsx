...
export default class Switch_Them extends Component{
    render(){
        return(
        <Switch_continer >
            <Squer_switch Mode={this.props.Mode} onClick={()=> this.props.Switch()}/> <Title_switch Mode={this.props.Mode} onClick={()=> this.props.Switch()}>{this.props.Mode ===  true ? "Light Mode" : "Dark Mode"}</Title_switch>
       </Switch_continer>)}
}
// --------------------- Register Page -------------------------
...
export const VideoSection = styled.section`
    ...
    position: relative;
    width: 60%;
@media only screen and  (max-width:1300px){height: 324px;width: 47%;}
@media only screen and  (max-width:1200px){height: 304px;width: 47%;}
@media only screen and  (max-width:100px){height: 268px;width: 50%;}
@media only screen and  (max-width:900px){height: 290px;width: 60%;}
@media only screen and  (max-width:800px){height: 257px;width: 60%;}
@media only screen and  (max-width:700px){height: 223px;width: 60%;}
@media only screen and  (max-width:600px){height: 174px;width: 55%;}
...
export const ButtonInButtonSection = styled.button`
    ...
    &:hover{background-color: rgba(255, 255, 255, 0.144);}
    &:hover ${ButtonInButtonSectionLink}{color: rgb(0, 0, 0);}
...
export const ButtonInButtonSectionTitle = styled.span`
             font-size: 1rem;
@media only screen and  (max-width:1108px){font-size: 0.9rem;}
@media only screen and  (max-width:742px){font-size: 0.7rem;}
`
