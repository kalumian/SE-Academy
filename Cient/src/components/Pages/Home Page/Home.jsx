    ...
    <>
      ...
      <div className="header-content">
        <Paragraf
          ...
          title2={"المجالات"}
          paragraf2={
            "(المجال المتاح حالياً هو مجال البرمجة)المجالات هي اول تقسيمات المحتوى العلمي في اكاديمية تعلم ذاتياً وتعنى بفصل جميع العلوم الى مواضيع عامة يسهل للمتعلم اختيار مجاله الذي يرغب بالخوض فيه"
          }
