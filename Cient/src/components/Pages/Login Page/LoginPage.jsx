...
import { Wrapper_Lg, CenterItems, MainLg, Input_Lg, Lable_Lg, Btn_Lg, UnderStyled_lg, Link_Lg, Icon_lg, Figure_lg, SpanHead_lg, Social_under_lg, } from '../../styled/PagesStyle'
        ...
        return(
            <Wrapper_Lg Mode={Mode}>
               ...
               {/* --------------- Main Sections ---------------*/}
                    ...
                    {/* --------------- Under Sections ---------------*/}
                    <UnderStyled_lg >
                            <span><Link_Lg  Mode={Mode} to="#">نسيت كلمة المرور</Link_Lg></span>
                            <span><Link_Lg  Mode={Mode} to="/register">تسجيل مستخم جديد</Link_Lg></span>
                    </UnderStyled_lg>
                    {/* --------------- Social Section  ---------------*/}
                    <div>
                           <Social_under_lg>
                               <Social Mode={Mode} icon="fab fa-telegram-plane fa-lg" title="انضم لقناتنا على التيليجرام "/>
                               <Social Mode={Mode} icon="fab fa-twitter fa-lg" title="تابع آخر الاخبار على تويتر" pd="50px"/>
